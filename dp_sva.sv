module dp_sva (
    ...
    property valid_spm_cmd;
        ...
        (seq_item_SPM.SPM_CMD == AUX_I2C_READ || seq_item_SPM.SPM_CMD == AUX_I2C_WRITE);
    endproperty
    ...
    property valid_spm_ack;
        @(posedge clk)
        seq_item_SPM.SPM_Reply_ACK_VLD |-> 
        (seq_item_SPM.SPM_Reply_ACK == I2C_ACK[3:2]);
    endproperty
    ...
    property valid_spm_transaction_vld;
        @(posedge clk)
        seq_item_SPM.SPM_Transaction_VLD |-> 1'b1;
    endproperty
    ...
    property valid_spm_address;
        @(posedge clk)
        seq_item_SPM.SPM_Address inside {[20'h00000:20'hFFFFF]};
    endproperty
    ...
    // Assertion 5: Valid LPM_CMD in native_read_request task
    ...
    // Assertion 10: Valid LPM_CMD in native_write_request task
    ...
    // Assertion 15: FSM_CR_Failed initialization
    ...
    // Assertion 16: Randomization of Link Parameters
    ...
    // Assertion 17: Valid Driving Parameters
